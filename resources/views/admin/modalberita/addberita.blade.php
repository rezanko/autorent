...
<div class="modal-body" style="padding:40px 50px;">
    {{--<form id="addber" name="addber" class="form-horizontal" role="form" files="true" method="POST" action="{{ url('/admin/berita/add/save') }}">--}}
        {!! Form::open(['id'=>'addber','name'=>'addber','action'=>'BeritaController@saveAddBerita', 'files'=>true])  !!}
        {{ csrf_field() }}
