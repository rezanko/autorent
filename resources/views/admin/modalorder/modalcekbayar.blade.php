...
<div class="modal-body" style="padding:40px 50px;">
        ...
        {!! Form::open(['id'=>'validbayar','name'=>'validbayar','action'=>'OrderController@confirmBayar'])  !!}
            {!! Form::hidden('order_id',$order->id) !!}
        {!! Form::close() !!}

        {!! Form::open(['id'=>'invalidbayar','name'=>'invalidbayar','action'=>'OrderController@invalidBayar'])  !!}
            {!! Form::hidden('order_id',$order->id) !!}
        {!! Form::close() !!}
        ...
        <div class="row">
            <div class="thumbnail">
                <img src="{{ URL::asset('/public/images/pembayaran/'.$bayar->pic) }}">
            </div>
        </div>
...
<form id="close-modal" action="{{ Session::forget('order','bayar') }}" style="display: none;">
</form>
